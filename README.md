# rpg-rs [![Crates.io](https://img.shields.io/crates/v/rpg.svg)](https://crates.io/crates/rpg) [![Build Status](https://travis-ci.org/rust-rpg/rpg-rs.svg?branch=master)](https://travis-ci.org/rust-rpg/rpg-rs)
